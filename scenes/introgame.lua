...
function introgame:new(manager)
...
function introgame:load()
    ...
    self.bkground.path = 'assets/pictures/textointrodutorio.png'
    self.bkground:load()
...
function introgame:keypressed(key, scancode, isrepeat)
...
function introgame:__config_tela()
...
function introgame:__config_font()
    self.font = love.graphics.newFont(30)
end

function introgame:__config_keys()
    self.keys = {}
